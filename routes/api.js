...
let ch = require('rizfurr-canvas')
let kc = require('rizfurr-canvas-v2')
...
let { emo1, emo2 } = req.params
try {
let buffer = await emomix(emo1, emo2)
res.type('png')
res.send(buffer)
} catch (e) {
res.status(500).send({ status: 500, success: false, message: 'please enter a valid emoji!' })
}
})
